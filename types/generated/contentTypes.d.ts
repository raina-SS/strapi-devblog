...
export interface ApiStaticPgeStaticPge extends Schema.CollectionType {
  collectionName: 'static_pges';
  info: {
    singularName: 'static-pge';
    pluralName: 'static-pges';
  ...
  attributes: {
    title: Attribute.String & Attribute.Required & Attribute.Unique;
    slug: Attribute.UID<'api::static-pge.static-pge', 'title'> &
      Attribute.Required;
    pageInfo: Attribute.Component<'layout.page-info'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::static-pge.static-pge': ApiStaticPgeStaticPge;
